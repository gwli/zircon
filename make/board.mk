...
$(BOARD_ZIRCON_ZBOOTIMAGE_DTB): BOARD_ZIRCON_BOOTIMAGE:=$(BOARD_ZIRCON_BOOTIMAGE)
...
else # PLATFORM_USE_GZIP

ifeq ($(PLATFORM_USE_MKKDTB),true)
$(BOARD_ZIRCON_ZBOOTIMAGE_DTB): $(BOARD_ZIRCON_BOOTIMAGE) $(DUMMY_DTB) $(KDTBTOOL)
	$(call BUILDECHO,generating $@)
	$(NOECHO)$(KDTBTOOL) $(BOARD_ZIRCON_BOOTIMAGE) $(DUMMY_DTB) $@
else
$(BOARD_ZIRCON_ZBOOTIMAGE_DTB): $(BOARD_ZIRCON_BOOTIMAGE) $(DUMMY_DTB)
	$(call BUILDECHO,generating $@)
	$(NOECHO)cat $(BOARD_ZIRCON_BOOTIMAGE) $(DUMMY_DTB) > $@
endif

endif # PLATFORM_USE_GZIP
